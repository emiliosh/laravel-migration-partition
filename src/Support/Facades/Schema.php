 ...
 *
 * @method static  createRangePartitioned(string $table, \Closure $callback, string $rangeKey)
 * @method static  createRangePartition(string $table, \Closure $callback, string $suffixForPartition, string $startValue, string $endValue)
 * @method static  attachRangePartition(string $table, \Closure $callback, string $partitionTableName, string $startValue, string $endValue)
 * @method static  getAllRangePartitionedTables()
 * List partitioning related methods.
 * @method static  createListPartitioned(string $table, \Closure $callback, string $listPartitionKey)
 ...
 * @method static  createHashPartitioned(string $table, \Closure $callback, string $hashPartitionKey)
